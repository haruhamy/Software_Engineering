            ...
            <div class="row">
                ...
                <div class="col-12 col-md-6">
                    ...
                    <form id="formContact">
                        ...
                        <input type="text" class="form-control mt-3" id="phone" name="phone" placeholder="Số điện thoại">
...
<script>
    $('#btnSendContact').click(function(e){
        ...
        if (!json['fullName']) {
            $('#fullName').after('<span style="color: red">Full name cannot be empty</span>');
            isValid = false;
        }
        $('#phone').next('span').remove();
        if (!json['phone']) {
            $('#phone').after('<span style="color: red">Phone cannot be empty</span>');
            isValid = false;
        }
        if(isValid){
            sendContact(json);
